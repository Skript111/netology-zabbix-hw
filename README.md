...
Скриншоты поступающих данных в этих элементов я прикладывал. Строка тут явно показана и она работает штатно!
...
Ниже представлен скриншот списка элементов данных в шаблоне (раскрыта куда еще то)
